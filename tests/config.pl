...
my @supportedDockerImages = ('debian:9', 'debian:10', 'ubuntu:20.04', 'centos:7', 'rockylinux:8');
...
config.pl [options]
 ...
 Docker Options:
   --docker-image       docker base image name ('debian:9', 'debian:10', 'ubuntu:20.04', 'centos:7', 'centos:8', 'rockylinux:8')
